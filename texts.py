...
Чтобы бот не ловил лимиты Telegram и не выдавал фейковые username, поиск берёт ники только из заранее проверенного пула.

Повтори чуть позже или включи цифры в фильтрах — такие варианты появляются быстрее."""
