...
class Settings(BaseSettings):
    ...
    MTPROTO_CHECK_DELAY_SECONDS: float = 0.20
    TELEGRAM_API_ID: int = 0
    TELEGRAM_API_HASH: str = ""
    TELEGRAM_STRING_SESSION: str = ""
    SEARCH_MAX_CANDIDATES: int = 14
    PRIME_SEARCH_MAX_CANDIDATES: int = 32
    PRIME_5_SEARCH_MAX_CANDIDATES: int = 70
    ...
    USERNAME_SUGGESTIONS_MAX_CANDIDATES: int = 25
    PRIME_USERNAME_SUGGESTIONS_MAX_CANDIDATES: int = 45
