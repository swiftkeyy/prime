...
class Settings(BaseSettings):
    ...
    MTPROTO_CHECK_DELAY_SECONDS: float = 0.85
    TELEGRAM_API_ID: int = 0
    TELEGRAM_API_HASH: str = ""
    TELEGRAM_STRING_SESSION: str = ""
    SEARCH_MAX_CANDIDATES: int = 10
    PRIME_SEARCH_MAX_CANDIDATES: int = 16
    PRIME_5_SEARCH_MAX_CANDIDATES: int = 28
    ...
    USERNAME_SUGGESTIONS_MAX_CANDIDATES: int = 12
    PRIME_USERNAME_SUGGESTIONS_MAX_CANDIDATES: int = 18
